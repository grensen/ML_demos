...
// https://jamesmccaffrey.wordpress.com/2024/01/15/using-news-articles-to-train-large-language-models/
// https://github.com/stephentoub/Tokenizer
// https://www.nuget.org/packages/Microsoft.DeepDev.TokenizerLib/

using Microsoft.DeepDev;

Console.WriteLine("Begin gpt-4 tokenizer demo");
...
string text = "The future of AI is impredictable."; // "Hello World";
// demo 1 encode tokens
StringToTokens(text);  //StringToTokens(IM_START + text + IM_END);
