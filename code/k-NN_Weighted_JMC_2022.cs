// https://jamesmccaffrey.wordpress.com/2022/06/08/weighted-k-nn-classification-using-csharp-2/
// https://visualstudiomagazine.com/articles/2022/05/19/weighted-k-nn-classification.aspx
...
static double[] MakeWeights(int k, Span<double> distances)
{
    // Inverse technique
...
static double DistFunc(Span<double> item, Span<double> dataPoint)
{
    double sum = 0.0;
    for (int i = 0; i < 2; ++i)
    {
